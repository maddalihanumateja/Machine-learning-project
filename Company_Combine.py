...
with open('data_4_back_raw.csv','w') as csvfile:
    ...
    CSVWriter.writerow(['Close Change n','Low Change n','High Change n','Twitter n','Close Change n-1','Low Change n-1','High Change n-1','Twitter n-1','Close Change n-2','Low Change n-2','High Change n-2','Twitter n-2','Close Change n-3','Low Change n-3','High Change n-3','Twitter n-3','Close Change n-4','Low Change n-4','High Change n-4','Twitter n-4','Close Change n-5','Low Change n-5','High Change n-5','Twitter n-5'])
    for row in data_4:
